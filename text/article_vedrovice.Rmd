...
On the other hand the methods based on distances between nearest neighbours
characterize the point pattern in regards to *second-order effects*.
In this case it is presumed that the point location depends on other
point locations.
Functions $G$, Ripley's $K$ [@ripley1976] and $L$ are explored as the most widely
used distance-based point pattern measures [@nakoinz2016, 135-144; @osullivan2010, 130-139]

We assume that in case of a burial ground *first-order properties* are
of little to no importance at all.
In case of spatial analysis of settlement structure, individual locations of
...
In case of a grave placement we presume that the choice of a location is influenced
solely by other (previous) grave locations.
The *second-order properties*, and possibly *third-order properties* [@nakoinz2016, 130, 144]
which take into account triplets of points, thus effectively the overall structure of the pattern,
are considered major factors in locating the graves.
