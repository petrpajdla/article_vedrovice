...
two methods to establish neighborhood.
The first method is based on constructing a Gabriel graph [@gabriel1969]
with burial locations as nodes (Fig. \@ref(fig:gabriel)).
Gabriel graph is a subgraph of a Delaunay triangulation
...
The second approach of establishing neigborhood is by constructing buffer zones
around each of the burials with 6m radius.
...
described for the neighborhood derived from the Gabriel graph.
