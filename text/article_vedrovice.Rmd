...
sex, age, origin, exceptionality of grave goods and location within the
cemetery.
...
and which tend to appear together more often than it would be expected by random chance only
...
To assess relations between groups based on sex, age local origin and exceptionality,
...
To solve this problem we utilise percolation analysis [@maddison2020].
