...
The density of burials is examined using quadrat test and the $G$ function while
the distance between neighbours usnig Ripley's $K$ function and its derivative, the
$L$ function [@ripley1976].
...
knitr::include_graphics(here("plots", "pointprocess_gl.pdf"))
```
